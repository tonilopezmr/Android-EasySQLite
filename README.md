...
Use easily the database SQLite on android using the DAO and transformer design patterns, I modified the library of the professor [@jvprofe][11], I learned it from him.
...
```gradle
compile 'com.github.tonilopezmr:easysqlite:2.0.1'
````
